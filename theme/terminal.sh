...
# =============================================================================
# Maps palette slots 0-15 to colors from palette.sh.
# Used by the generator to produce Ghostty config and nvim palette.lua.
#
# Slot    Name              Value
# ----    ----              -----
...
PALETTE_8="$SILVER_600"     # bright black (dark gray)
