...
" Misc Vim stuff
Plugin 'vim-scripts/BufOnly.vim'          " Close all but current buffer
Plugin 'tpope/vim-sleuth'                 " Smarter shiftwidth and expandtab
...
Plugin 'jiangmiao/auto-pairs'             " Better(?) complete quotes, parends etc
...
Plugin 'othree/csscomplete.vim'           " CSS
...
Plugin 'samuelsimoes/vim-jsx-utils'       " JSX helpers
