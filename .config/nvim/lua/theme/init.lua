...
local function setup()
  ...
  hi("@markup.heading", { fg = orange, bold = true })
  ...
  hi("@punctuation.bracket", { fg = orange })
  hi("@punctuation.delimiter", { fg = pink, bold = true })
  ...
  hi("@text.danger", { fg = pink, bold = true })
  hi("@text.todo", { fg = pink, bold = true })

  hi("@type.qualifier", { fg = purple, bold = true })
  hi("@type.builtin", { fg = blue, italic = true })

  hi("@variable", { fg = fg })
  hi("@variable.parameter", { fg = orange })
  ...
  hi("@lsp.type.type", { fg = p.silver_400, italic = true })
  hi("@lsp.typemod.defaultlibrary", { fg = purple })
